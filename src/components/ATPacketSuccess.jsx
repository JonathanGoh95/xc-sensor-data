...
export default function ATPacketSuccess({pageItems,results,handleBack,handleRefresh}){
    ...
    return(
        <>
            <h1 className="font-bold italic text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center">ATmega Packet Sender Data</h1>
